...
% Enable numbering for subsubsection (level 3) only
% Level 4 (paragraph) will be unnumbered
...
%
% The following tells the geometry package to use a two-sided layout
% ASU Guidelines: Left/Inner = 3cm, Right/Outer = 2.5cm
\newgeometry{
    top=2.5cm,
    bottom=2.5cm,
    inner=3cm,
    outer=2.5cm,
    headheight=36pt, % Increased for header logo
    footskip=1.5cm, % Push footer lower
    bindingoffset=0cm
}
