...
\include{chapters/chapter6_hardware}
% Ch.7 — Multi-Robot Swarm, Collaborative Mapping and Perception
%         (merged from former Ch.7 swarm + former Ch.8 perception)
\include{chapters/chapter7_swarm}
% Ch.8 — Experimental Results & Discussion  (formerly chapter9_results)
\include{chapters/chapter9_results}
% Ch.9 — Conclusion & Future Recommendations (formerly chapter10_conclusion)
